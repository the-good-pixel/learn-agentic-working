...
- **Recurring business reports** for a small team. Keep your DB. Skip the BI dashboard subscription for a three-person team. A long-running agent (Ch. 15) runs the query each Monday and posts the chart to Slack.
