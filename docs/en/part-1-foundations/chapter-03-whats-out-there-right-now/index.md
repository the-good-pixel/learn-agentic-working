...
**When to reach for this family**: any tool that has no API, no MCP, and lives only as a webpage. Vendor portals. Internal admin tools. Government sites. SaaS settings pages your team uses once a month. Also useful for testing a product you've built — *dogfooding* the way a real user would. Ch. 24 is a deep dive on this family with concrete scenarios.
