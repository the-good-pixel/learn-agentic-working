...
We named these connectors and workflows in earlier chapters. An **MCP** (Ch. 9) is an app installed on the agent's phone — a connector that gives it a new tool, like "talk to Shopify" or "talk to Google Ads". A **skill** (preview from Ch. 9, full treatment in Ch. 16–18) is a saved procedure — a war-story or a team SOP captured as a reusable named workflow.
