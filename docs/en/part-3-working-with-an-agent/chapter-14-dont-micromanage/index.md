...
Some rules are non-negotiable even at a quality cost. Safety policy. Legal compliance. Geopolitical naming (the `i18n-reviewer` skill in Ch. 19 says *"never use 'country' alone when listing regions that include Taiwan, Hong Kong, or Macau"* — that's a business rule the company cannot afford to soft-enforce). Accessibility requirements. Brand-trademark spellings the legal team insists on.
