...
- **FX rates: ECB daily reference rates** for EUR/GBP/JPY/HKD/SGD;
...
specialty foods in Hong Kong. I run AR/AP, monthly reconciliation,
quarterly board pack, and the payroll handoff to our outsourced
provider. I live in Xero, HSBC business banking, Stripe (online
...
- **Default currency: HKD.** Every spreadsheet, every report.
- **Foreign-currency sources: convert explicitly.** Cite the rate
  inline and date it. Format: `USD 1,200 @ 7.82 (HSBC 2026-05-01) =
  HKD 9,384`. Never silently drop the original.
- **FX source: HSBC daily TT rate** for the date of the transaction
...
- **No rounding under HKD $5 in any deliverable.** A figure of
...
- Any bank transfer or scheduled payment in HSBC.
- Any Stripe refund over HKD $500.
