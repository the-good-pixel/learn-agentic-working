...
**Three.** If you don't have a real screenshot handy, the book repo ships two text mockups of "the kind of thing you'd photograph and hand over" at [`examples/ch-22-vision/`](/examples/ch-22-vision/) — a confusingly-formatted Japanese-restaurant receipt with a buried service charge, and a benefits-portal form full of jargon ("Beneficiary Election Reaffirmation Schedule"). Pick one and hand it to your agent with one sentence: *"explain this to me — what did I pay for / what is it asking me to do?"*
