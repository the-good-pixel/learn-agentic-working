...
1. **Flagship — reconcile invoices against Stripe.** Run the finance-ops flagship against [`examples/ch-20-finance-ops/`](/examples/ch-20-finance-ops/):
...
2. **Resume screening.** Run the HR flagship against [`examples/ch-20-hr/`](/examples/ch-20-hr/):
