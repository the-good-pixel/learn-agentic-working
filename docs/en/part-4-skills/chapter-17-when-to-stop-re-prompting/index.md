...
Ch. 18 takes you through the two flows that produce a skill — search before you write, then write-from-conversation — and dissects real skills with different *shapes*, so you can recognize which shape your candidate fits.
