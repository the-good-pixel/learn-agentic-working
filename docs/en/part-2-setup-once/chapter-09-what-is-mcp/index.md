...
- [ ] An intuitive feel for the difference between *"the agent can't reach this"* (need an MCP) and *"the agent reaches it but does the wrong thing"* (need a skill, Ch. 16–18).
